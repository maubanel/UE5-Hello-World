...
<sub>[previous](../building-h-ii/README.md#user-content-building-the-letter-h-II) • [home](../README.md#user-content-ue4-hello-world) • [next](../displacement-ii/README.md#user-content-diplacement-h-ii)</sub>
...
##### `Step 19.`\|`UE5HW`| :large_blue_diamond: :small_orange_diamond: :small_blue_diamond: :small_blue_diamond: :small_blue_diamond: :small_blue_diamond:
 ...
 So I am going to reduce the poly count to remov some of the noise.  I go to **MeshOps** and select **Simplify**. I set the **Target Percentage** to `1` to `20` %.  I like the poly flow much better now.
...
![polygroups on each face](images/polyGroupsForUVs.png)
...
| [previous](../building-h-ii/README.md#user-content-building-the-letter-h-II)| [home](../README.md#user-content-ue4-hello-world) | [next](../displacement-ii/README.md#user-content-diplacement-h-ii)|
|---|---|---|
